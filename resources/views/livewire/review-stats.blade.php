<div>
    <div class="mt-6">
        ...
        <dl class="space-y-3">
            @foreach ($reviewsStats as $rating => $stat)
                <div class="flex items-center text-sm">
                    <dt class="flex flex-1 items-center">
                        <p class="w-3 font-medium text-gray-900">{{ $rating }}<span class="sr-only"> star reviews</span></p>
                        <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                            ...
                            <div class="relative ml-3 flex-1">
                                ...
                                <div style="width: {{ $stat['percentage'] }}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                            </div>
                        </div>
                    </dt>
