...
<div
    class="mx-auto max-sm:max-w-2xl py-20 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:py-32">
    <div class="lg:col-span-4">
        ...
        <div class="mt-3 flex items-center">
            ...
            <p class="ml-2 text-sm text-zinc-900">
                Based on {{ $this->productReviews->reviews->count() }} reviews
            </p>
        </div>

        <livewire:review-stats :$product />
        ...
        @auth
            <div class="mt-10">
                ...
                <div class="mt-6">
                    <livewire:modals.product.add-product-review :$product />
                </div>
            </div>
        @endauth
    </div>
        ...
        <div class="mt-16 lg:col-span-7 lg:col-start-6 lg:mt-0">
            ...
            @if ($reviews->count() > 5)
                <div class="flex justify-center pt-6">
                    <flux:button
                        type="button"
                        wire:click="$dispatch('openPanel', { component: 'slide-overs.reviews-list', arguments: { product: {{ $this->product->id }} }})"
