        ...
        <div class="relative flex gap-3">
            ...
            <div class="flex-1 space-y-0.5">
                ...
                <p class="text-sm text-gray-700">
                    <span class="text-gray-500">{{ __('Prix unitaire') }}</span> : {{ shopper_money_format($item->unit_price_amount, $currency_code) }}
                </p>
                <p class="text-sm text-gray-700">
                    <span class="text-gray-500">{{ __('Quantité') }}</span> : {{ $item->quantity }}
                </p>
            </div>
        </div>
    @endforeach
