...
@if ($href)
    ...
    >
        <span
            class="absolute inset-0 z-0 transform border-2 border-red-600 rounded-lg p-1 transition-transform group-hover:translate-x-1 group-hover:translate-y-1 group-focus:-translate-y-1 group-focus:translate-x-1"
        ></span>
        <span class="absolute inset-0 bg-red-600 rounded-lg z-0"></span>
