...
<label aria-label="Washed Black"
    ...
    <span aria-hidden="true" class="size-8 bg-gray-700 border border-black/10 rounded-full"></span>
</label>
...
<label aria-label="Washed Gray"
    ...
    <span aria-hidden="true" class="size-8 bg-gray-500 border border-black/10 rounded-full"></span>
</label>
