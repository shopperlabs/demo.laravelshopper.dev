    ...
    <div>
      <h3>
        ...
        <button type="button" class="relative flex items-center justify-between w-full py-6 text-left group" aria-controls="disclosure-1" aria-expanded="false">
          <!-- Open: "text-indigo-600", Closed: "text-zinc-900" -->
          <span class="text-sm font-medium text-zinc-900">Features</span>
          <span class="flex items-center ml-6">
            <!-- Open: "hidden", Closed: "block" -->
            <svg class="block size-6 text-zinc-400 group-hover:text-zinc-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
